    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <form id="form-hadir" action="{{ url('admin/kkn/csv/') }}" method="POST" style="display: inline;">
            @csrf
            @method('POST')
            <button type="submit" class="btn btn-primary">Cetak CSV</button>
        </form> 
            <!--<a href="{{url('admin/kkn/create')}}" class="btn btn-primary">Tambah Data</a>-->        
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <a href="{{url('admin/kkn/list')}}" class="btn btn-success" style="margin-top: 30px;">Reset</a>
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
                  ...
                  <tbody>
                    @foreach($getRecord as $value)
                      <tr>
                        ...
                        <td>
                          <a href="{{url('admin/kkn/edit/'.$value->id)}}" class="btn btn-primary">Edit</a>
                          <!-- <a href="{{url('admin/kkn/delete/'.$value->id)}}" class="btn btn-danger" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')">Hapus</a> -->
                        </td>
                      </tr>
                    @endforeach
                  </tbody>
